...
| :--- | :--- | :--- |
| **[`RULES.md`](./RULES.md)** | **Imperatively** coding standards | Technical and structural rules using RFC 2119 keywords (*MUST*, *SHOULD*, *MAY*). |
...
- **[`README.md`](./README.md)** — Temporary location for system overview and initial draft ADRs (ADR-001 through ADR-007) until migrated to `docs/adrs/`.
...
2. VERIFY PLAN   ──> Validate task design against RULES.md and ADRs in docs/adrs/. Read ADRs from highest to lowewt number, ignore conföicting eaeliwr ADRs.
